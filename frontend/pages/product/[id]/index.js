...
const Index = ({ product }) => {
  ...
  const { message, isError, isSuccess } = useSelector((state) => state.cart);

  useEffect(() => {
    if (isError && message) toast.warning(message);
                      ...
                      <div class="product-entry">
                        ...
                        <div class="thumb-nail">
                          ...
                          <a
                            ...
                            class="thumb-img"
                            style={{
                              backgroundImage: `url(../images/item-12.jpg)`,
                            }}
                          ></a>
                          <a
                            href="#"
                            class="thumb-img"
                            style={{
                              backgroundImage: `url(../images/item-16.jpg)`,
                            }}
                          ></a>
                        </div>
                      </div>
