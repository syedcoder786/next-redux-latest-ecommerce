            ...
            <div class="row">
              <div class="col-md-6">
                <a
                  href="shop.html"
                  class="f-product-1"
                  style={{ backgroundImage: `url(images/item-1.jpg)` }}
                >
                  <div class="desc">
                    <h2>
                      Fahion <br />
                ...
                <div class="row">
                  <div class="col-md-6">
                    <a
                      href=""
                      class="f-product-2"
                      style={{ backgroundImage: `url(images/item-2.jpg)` }}
                    >
                      <div class="desc">
                        <h2>
                          New <br />
                  ...
                  <div class="col-md-6">
                    <a
                      href=""
                      class="f-product-2"
                      style={{ backgroundImage: `url(images/item-4.jpg)` }}
                    >
                      <div class="desc">
                        <h2>
                          Sale <br />
                  ...
                  <div class="col-md-12">
                    <a
                      href=""
                      class="f-product-2"
                      style={{ backgroundImage: `url(images/item-3.jpg)` }}
                    >
                      <div class="desc">
                        <h2>
                          Shoes <br />
            ...
            <div class="row">
              <div class="col-md-3 text-center">
                <div class="product-entry">
                  <div
                    class="product-img"
                    style={{ backgroundImage: `url(images/item-9.jpg)` }}
                  >
                    <p class="tag">
              ...
              <div class="col-md-3 text-center">
                <div class="product-entry">
                  <div
                    class="product-img"
                    style={{ backgroundImage: `url(images/item-10.jpg)` }}
                  >
                    <p class="tag">
                      <span class="new">New</span>
                    </p>
              ...
              <div class="col-md-3 text-center">
                <div class="product-entry">
                  <div
                    class="product-img"
                    style={{ backgroundImage: `url(images/item-11.jpg)` }}
                  >
                    <p class="tag">
                      <span class="new">New</span>
                    </p>
              ...
              <div class="col-md-3 text-center">
                <div class="product-entry">
                  <div
                    class="product-img"
                    style={{ backgroundImage: `url(images/item-12.jpg)` }}
                  >
                    <p class="tag">
                      <span class="new">New</span>
                    </p>
              ...
              <div class="col-md-3 text-center">
                <div class="product-entry">
                  <div
                    class="product-img"
                    style={{ backgroundImage: `url(images/item-13.jpg)` }}
                  >
                    <p class="tag">
                      <span class="new">New</span>
                    </p>
              ...
              <div class="col-md-3 text-center">
                <div class="product-entry">
                  <div
                    class="product-img"
                    style={{ backgroundImage: `url(images/item-14.jpg)` }}
                  >
                    <p class="tag">
                      <span class="new">New</span>
                    </p>
              ...
              <div class="col-md-3 text-center">
                <div class="product-entry">
                  <div
                    class="product-img"
                    style={{ backgroundImage: `url(images/item-15.jpg)` }}
                  >
                    <p class="tag">
                      <span class="new">New</span>
                    </p>
              ...
              <div class="col-md-3 text-center">
                <div class="product-entry">
                  <div
                    class="product-img"
                    style={{ backgroundImage: `url(images/item-16.jpg)` }}
                  >
                    <p class="tag">
                      <span class="new">New</span>
                    </p>
